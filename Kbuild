...
ifeq ($(CONFIG_WLAN_PEER_TID_RATE_CTRL), y)
HDD_OBJS += $(HDD_SRC_DIR)/wlan_hdd_sysfs_peer_tid_rate.o
endif
ifeq ($(CONFIG_WLAN_ACK_RATE_CTRL), y)
HDD_OBJS += $(HDD_SRC_DIR)/wlan_hdd_sysfs_ack_rate.o
endif
endif
...
cppflags-$(CONFIG_WLAN_PEER_TID_RATE_CTRL) += -DWLAN_PEER_TID_RATE_CTRL
cppflags-$(CONFIG_WLAN_ACK_RATE_CTRL) += -DWLAN_ACK_RATE_CTRL
