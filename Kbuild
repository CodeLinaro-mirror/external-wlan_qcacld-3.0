...
ccflags-$(CONFIG_TX_DOWNLOAD_FREE_NO_CREDIT_UPDATE) += -DCONFIG_TX_DOWNLOAD_FREE_NO_CREDIT_UPDATE
...
ifeq (y,$(filter y,$(CONFIG_HIF_PCI) $(CONFIG_HIF_IPCI) $(CONFIG_HIF_SNOC)))
...
ccflags-$(CONFIG_OL_TXRX_PEER_UNMAP_TRACK) += -DOL_TXRX_PEER_UNMAP_TRACK
